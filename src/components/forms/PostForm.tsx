        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea placeholder="Enter your caption..." className="shad-textarea custom-scrollbar" {...field} />
              </FormControl>
...
//                allows you to access the property of post without first checking it it exists
                />
              </FormControl>
              <FormMessage className="shad-form_message" />
            </FormItem>
        ...
        <div className="flex gap-4 items-center justify-end">
          ...
          >
            {/* if isLoadingCreate or isLoadingUpdate, then return "Loading..." */}
